...
class DeviceParams(object):
    def __init__(self, config_file, warning_msg=False):
...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate device parameters script for DCOP analysis.")
    parser.add_argument('--config_file', type=str, required=True,
                        help="path to the corresponding .yaml file")
    parser.add_argument('--file_name', type=str, required=True,
                        help="path to the op file")
...
if __name__ == '__main__':
    args = parse_args()   
    dev_params_script = DeviceParams(args.config_file).gen_dev_params(args.file_name)
